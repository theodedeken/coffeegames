...
public class KeyConfiguration extends HashMap<String, KeyState> implements Resource {
    private static final Logger LOGGER = Logger.getLogger(KeyConfiguration.class.getName());
