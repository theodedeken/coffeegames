...
public final class Resources {
    ...
    public void initLoadingResources() {
        ...
        Map<String, Image> images = voide.resources.Resources
            .get()
            .getNamespaceResources("image", Image.class);
        Map<String, ImagePart> image_parts = voide.resources.Resources
            .get()
            .getNamespaceResources("image_part", ImagePart.class);
        ...
        voide.resources.Resources
            .get()
            .addResource("voide.packed_texture", root);
        for (Entry<String, ImagePart> entry : result.parts.entrySet()) {
            ...
            voide.resources.Resources
                .get()
                .addResource(
                    entry.getKey().replace("image.", "texture."),
        ...
        for (Entry<String, ImagePart> entry : image_parts.entrySet()) {
            voide.resources.Resources
                .get()
                .addResource(
                    entry.getKey().replace("image_part.", "texture."),
                    entry.getValue().toTexture(rootId)
                );
        }
    }
    ...
    public void startLoading() {
        ...
        Map<String, ItemProperties> loadedItems = voide.resources.Resources
            .get()
            .getNamespaceResources("item", ItemProperties.class);
        ItemCatalogue items = new ItemCatalogue(loadedItems);
        voide.resources.Resources
            .get()
            .addResource("spaxel.item_catalogue", items);
    }
