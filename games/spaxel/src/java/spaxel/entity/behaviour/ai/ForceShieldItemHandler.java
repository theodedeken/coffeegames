...
public class ForceShieldItemHandler extends ShieldHandler {
    ...
    public void handleProjectile(Entity entity, Entity projectile) {
        ProjectileStorage dmgStore = (ProjectileStorage) projectile.getComponent(SpaxelComponent.PROJECTILE);
        ...
        if (dmgStore.getDamage() < shldStore.getCurrentCapacity()) {
            ...
            ChangeStorage vc = (ChangeStorage) projectile.getComponent(SpaxelComponent.CHANGE);
