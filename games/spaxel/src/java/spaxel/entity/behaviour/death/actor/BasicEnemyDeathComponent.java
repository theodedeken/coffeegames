...
public class BasicEnemyDeathComponent extends DeathHandler {
        ...
        public void die(Entity entity) {
                SpawnerIndustry hpsi = voide.resources.Resources.get()
                                .getResource("enemy_death_particle_spawner_industry", SpawnerIndustry.class);

                RenderableStorage rndrStore = (RenderableStorage) entity.getComponent(SpaxelComponent.RENDERABLE);
                ...
                ExperienceStorage exp = (ExperienceStorage) player.getComponent(SpaxelComponent.EXPERIENCE);
                exp.addXp(BASIC_ENEMY_XP_GAIN);
                // chance of dropping item
                if (random.pass(BASIC_ENEMY_DROPRATE)) {
                        Entity item = voide.resources.Resources.get()
                                        .getResource("spaxel.item_catalogue", ItemCatalogue.class)
                                        .produceRandom(prop -> EntityUtil.getAllItemNames(entity)
