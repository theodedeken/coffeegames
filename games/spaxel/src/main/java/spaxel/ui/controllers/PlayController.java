...
public final class PlayController {
    ...
    public static void updateHpBar(Element element) {
        ...
        element
            ...
            .setProperty(
                "completion",
                String.valueOf(
                    (double) hc.getCurrentHealth() / hc.getMaxHealth()
                )
            );
        element
            .findById("hp_label")
    ...
    public static void updateXpBar(Element element) {
        ...
        element
            .findById("xp_label")
            .getStyle()
            .setProperty("text", ec.getCurrentXp() + " / " + ec.getMaxXp());
    }
        ...
        updateContainer(
            ...
            EntityUtil
                ...
                .getLinks(
                    e ->
                        (
                            (ItemStorage) e.getComponent(SpaxelComponent.ITEM)
                        ).getContainer() ==
    ...
    public static void updateLoggingLabel(Element element) {
        ...
        long dif =
            logger.getHistory().get(type.name()).getLast().getDifference() /
            Constants.NS_PER_US;
        ...
        element
            .getStyle()
            .setProperty("text", type.getName() + ": " + avg + "(" + dif + ")");
    }
}
