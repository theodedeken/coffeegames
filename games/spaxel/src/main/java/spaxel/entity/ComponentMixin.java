...
@JsonSubTypes(
    {
        @JsonSubTypes.Type(value = HitBehaviour.class, name = "HIT"),
        ...
        @JsonSubTypes.Type(
            value = TransformationStorage.class,
            name = "TRANSFORMATION"
        ),
        @JsonSubTypes.Type(
            value = RenderableStorage.class,
            name = "RENDERABLE"
        ),
...
/**
 * Mixin to help Jackson with serialisation
 */
